...
function deploy(action) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield (0, execute_1.execute)(`rsync -av --checksum --progress ${isMkpathSupported && action.targetFolder ? '--mkpath' : ''} ${action.folderPath}/. ${action.targetFolder
            ...
            if (action.targetFolder) {
                yield (0, execute_1.execute)(`git add --all ${action.targetFolder}`, `${action.workspace}/${temporaryDeploymentDirectory}`, action.silent);
            }
